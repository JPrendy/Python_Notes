...
class Warrior:
    ...
    def attack(self):
        ...
        attackAmount = self.attkMax * (random_number + .5)
    ...
    def block(self):
        ...
        random_number = randint(1, 5)
        blockAmount = self.blockMax * (random_number + .5)
...
class Battle:
    ...
    def getAttackResult(warriorA, warriorB):
        ...
        damage2WarriorB = warriorAAttkAmt - warriorBBlockAmt
...
def main():
    ...
    # Initiate Battle
    #we are using the data we made in the Warrior class and carrying it
    #over to the the Battle class
